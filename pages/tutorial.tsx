				...
				<div className="min-h-[90vh] w-[100%] flex items-center justify-center relative px-2">
					...
					<div className="flex flex-col justify-center items-center p-10 md:gap-10 gap-4 bg-overlay md:p-20 p-10 rounded-md relative">
						...
						<div className="flex sm:flex-row flex-col md:gap-10 gap-4">
							<Button
								className={clsx(
									'z-10 border borderMain relative sm:px-16 p-4 py-4 text-white transition ease-in-out delay-150 hover:-translate-y-1   hover:shadow-button hover:scale-110 duration-300  ',
									Styles.button
								)}
							...
							<Button
								className={clsx(
									'z-10 border borderMain sm:px-16 p-4 py-4 text-white',
									Styles.button
								)}
